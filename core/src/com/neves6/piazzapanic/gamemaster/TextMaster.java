...
public class TextMaster {
     ...
     * @return String containing the display text.
     */
    public String generateReputationPointText(float totalTimerDisplay, float lastRepPointLost, int reputationPoints) {
        String comp = "";
     ...
     * @return String containing the display text.
     */
    public String generateCustomersTrayText(Queue<Customer> customers, ArrayList<String> tray1, ArrayList<String> tray2) {
        String comp = "";
