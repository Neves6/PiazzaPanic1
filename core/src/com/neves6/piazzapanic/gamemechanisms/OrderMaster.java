...
public final class OrderMaster {
    final static ArrayList<String> RECIPES =
     ...
     */
public static float checkOrderExpired(Queue<Customer> customers, float totalTimerDisplay, int difficulty, int reputationPoints, int customersServed, float lastRepPointLost) {
     ...
     */
    public static float createCustomers(Queue<Customer> customers, float lastCustomer, int customersServed, int customersGenerated, int maxCustomers, int difficulty, float totalTimer) {
