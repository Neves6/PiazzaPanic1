...
public class PowerUpRunner {
  ...
  /**
   * Choose a random number between 0 and 1 and convert to an integer in the range 0 to 4
   * and then uses this to pick a random power-up to activate.
   */
  ...
  /**
   * Runs method for all power-ups that will end the timer on them
   * if this is required.
