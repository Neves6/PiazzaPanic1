...
public class TestPowerUpRunner {
    Chef c1 = new Chef("test", 1, 1, 1, 1, 1, false,
            new Stack<>(), 1);
    Money mo1 = new Money();
    ...
    public void testPrettyPrintNoPowerups() {
        ...
        assertTrue("If no powerup has been activated, text must just contain Current Active Powerups: '",
    ...
    public void testPrettyPrintPowerups() {
        ...
        assertTrue("Text must just contain ' Current Active Powerups: ' even if a powerup is activated.",
                testRunner.displayText().startsWith("Current Active Powerups: \n"));
        assertTrue("Once a powerup is active, it should show the text for the powerup activated.",
    ...
    public void testGetCorrectDelta() {
        ...
        PowerUpRunner testRunner = new PowerUpRunner(testChefs, machines, mo1);
        testRunner.activateRandomPowerUp();
        assertTrue("Delta must be 0 or the parameter entered",
