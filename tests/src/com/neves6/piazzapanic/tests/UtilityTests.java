...
public class UtilityTests {
    ...
    public void testSettingsFileReadDefaultValues() {
        ...
        Assert.assertTrue("Default settings file contents don't match expected values", settings.equals(defaultSettings));
    }
    ...
    public void testSettingsFileReadWriteNewValues() {
        ...
        ArrayList<String> settings = Utility.getSettings();
        // Test if values read from file match expected values
        Assert.assertTrue("Edited settings file contents don't match expected changes", settings.equals(newSettings));
    }
}