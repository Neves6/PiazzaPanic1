...
public class TestTextMaster {
    ...
    public void testReputationPointTextStart(){
       assertTrue("If no reputation points have been lost in the first 3 seconds" +
               " shown", tm.generateReputationPointText(2f, 0f, 3).equals("Reputation points: 3"));
    }
    ...
    public void testReputationPointText(){
        assertTrue("If no reputation points have been lost in the past 3 seconds only the reputation points should be" +
                " shown", tm.generateReputationPointText(100f, 0f, 3).equals("Reputation points: 3"));
    }
    ...
    public void testGenerateCustomerLeft(){
        assertTrue("If a customer has left it should notify the user"
                , tm.generateCustomerLeftText(100f, 102f).equals("A customer was tired of waiting\n" +
                        "Reputation point lost"));
    }

    @Test
    public void testGenerateCustomerLeftStarting(){
        assertTrue("A customer should not lose points in the first 3 seconds."
