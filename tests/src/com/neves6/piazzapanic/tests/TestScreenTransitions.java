...
public class TestScreenTransitions {
  ...
  //    }
  //    assertSame(
  //        "After a fixed period of time, the intro screen must automatically transition to the
  // title"
  //            + " screen.",
  //        testGame.getScreen().getClass(),
  //        TitleScreen.class);
  ...
  //    testTutorial.keyDown(0);
  //    assertSame(
  //        "Pressing any button with the continueTo set to anything apart from game1/2/3 should
  // lead"
  //            + " to the game screen",
  //        testGame.getScreen().getClass(),
  //        TitleScreen.class);
